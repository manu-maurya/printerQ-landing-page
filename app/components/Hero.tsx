    ...
    <div className="relative flex items-center justify-center bg-p-grey-dark h-screen w-full">
      ...
      <section className="z-10 text-center px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <button className="mt-8 px-6 py-3 bg-linear-to-br from-p to-p-dark hover:scale-105 hover:border border-p-cream transition-transform text-white text-lg font-bold rounded-full relative uppercase">
            Join Waitlist
          </button>
        </div>
      </section>
