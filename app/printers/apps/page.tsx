      ...
      <div className="flex-1 flex items-center justify-center px-4 relative">
        ...
        <section className="z-10 text-center max-w-5xl mx-auto">
          <h1 className="lg:text-8xl md:text-7xl text-5xl font-extrabold text-p-cream mb-6 leading-tight">
            printerQ Printer Partner App
          </h1>
          <h2 className="lg:text-7xl md:text-6xl text-4xl font-bold bg-linear-to-r from-s to-p bg-clip-text text-transparent mb-4 animate-pulse pb-4 leading-tight">
            Coming Soon
          </h2>
          <p className="text-text-secondary-light text-lg md:text-xl mt-2 max-w-2xl mx-auto">
